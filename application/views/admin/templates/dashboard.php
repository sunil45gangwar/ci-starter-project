      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <a href="<?php echo site_url(); ?>admin/profile"><i class="fa fa-circle text-success" aria-hidden="true"></i> Online</a>
            </div>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo site_url(); ?>admin/pages"><i class="fa fa-circle-o" aria-hidden="true"></i> Dashboard v1</a></li>
              </ul>
            </li>
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              <li><a href="<?php echo site_url(); ?>admin/pages"><i class="fa fa-dashboard" aria-hidden="true"></i> Home</a></li>
